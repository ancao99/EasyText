  ...
  AppBar myAppBar() {
    if (appBarMap[pageIndex][0] == "") {
      return AppBar(title: Text(appBarTitle[pageIndex],
        style: TextStyle(color: Colors.black), // Replace 'Colors.white' with your desired title color
      ));
    } else {
      return AppBar(
        ...
        backgroundColor: Colors.blue[100], // Replace 'Colors.blue' with your desired color
        actions: <Widget>[
          PopupMenuButton<int>(
      ...
      child: ListView(
        ...
        children: [
          ...
          ListTile(
            ...
            onTap: () async {
              Navigator.of(context).pushReplacementNamed('/deleteAccount');
              setState(() {
                listener!.cancel();
              });
            },
    ...
    return Container(
      decoration: BoxDecoration(
        image: DecorationImage(
          image: AssetImage("assets/homepage.png"), // Replace with your image path
          fit: BoxFit.cover,
        ),
      ),
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          return Card( // Wrap the ListTile with Card widget
            elevation: 3, // Set the elevation for the card
            shape: RoundedRectangleBorder(
              borderRadius: BorderRadius.circular(8), // Set the border radius for the card
            ),
            child: ListTile(
              onTap: () {
                Navigator.push(
              ...
              title: Text(
                (listTasks[index].nameEvent == null
                    ? "Task $index"
